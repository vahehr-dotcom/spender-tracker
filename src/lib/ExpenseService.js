...
const CATEGORY_KEYWORDS = {
  ...
  'Haircuts & Barber': ['haircut', 'barber', 'barbershop', 'hair cut', 'fade', 'trim', 'fantastic sams', 'supercuts', 'great clips', 'sports clips', 'floyd'],
  'Salon & Spa': ['salon', 'spa', 'nails', 'manicure', 'pedicure', 'facial', 'massage', 'waxing', 'lash', 'brow'],
  'Skincare & Beauty': ['sephora', 'ulta', 'beauty', 'skincare', 'makeup', 'cosmetics', 'lotion', 'serum'],
  'Personal Hygiene': ['deodorant', 'shampoo', 'conditioner', 'toothpaste', 'razor', 'shaving', 'body wash', 'soap'],
