...
const CATEGORY_KEYWORDS = {
 ...
 'Barbershop': ['barber', 'barbershop', 'fade', 'trim', 'lineup', 'shave', 'sports clips', 'floyd'],
  'Hair & Beauty': ['salon', 'hair salon', 'hair color', 'blowout', 'hair products', 'lashes', 'brows', 'lash', 'brow', 'nails', 'manicure', 'pedicure', 'waxing', 'styling', 'hairstylist', 'fantastic sams', 'supercuts', 'great clips', 'haircut', 'hair cut'],
  'Skincare & Cosmetics': ['sephora', 'ulta', 'beauty', 'skincare', 'makeup', 'cosmetics', 'lotion', 'serum', 'facial'],
  'Personal Hygiene': ['deodorant', 'shampoo', 'conditioner', 'toothpaste', 'razor', 'shaving', 'body wash', 'soap', 'feminine products', 'tampons', 'pads'],
  'Spa & Wellness': ['spa', 'massage', 'sauna', 'steam room', 'meditation'],
  'General Personal Care': ['personal care', 'self care'],
  ...
  'Grooming': ['pet grooming', 'dog grooming', 'cat grooming', 'pet salon'],
